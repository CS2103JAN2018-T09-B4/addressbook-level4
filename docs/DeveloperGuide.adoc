...
|`* * *` |As a part of a couple in NUS |encrypt my NUSCouples save data |prevent strangers from reading personal information such as my journal entries
...
|`*`| user with a romantic partner  | send motivational pictures | encourage my partner
=======
...
[discrete]
=== Use case: Add Timetable to Partner

*MSS*

1.  User request to add a shortened http://nusmods.com[NUSMODS] timetable url to his/her partner.
2.  NUSCouples adds the url to the partner.
+
Use case ends.
...
[none]
* 1a. The partner already has a timetable.
+
[none]
** 1a1. NUSCouples prompts user to override existing timetable.
** 1a2. User confirms change.
+
Use case resumes at step 2.

* 1b. The given url is invalid.
+
[none]
** 1b1. NUSCouples shows an error message.
+
Use case ends.
